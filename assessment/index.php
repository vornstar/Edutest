...
$routes = [
    ...
    ['GET', '/teacher/papers/inbox', [PaperController::class, 'inboxForm']],
    ['POST', '/teacher/papers/inbox/upload', [PaperController::class, 'inboxUpload']],
    ['POST', '/teacher/papers/inbox/{id}/attach', [PaperController::class, 'attachInbox']],
    ['POST', '/teacher/papers/inbox/{id}/delete', [PaperController::class, 'deleteInbox']],
    ['GET', '/teacher/papers/{id}', [PaperController::class, 'show']],
    ['POST', '/teacher/papers/{id}/questions', [PaperController::class, 'addQuestion']],
    ['POST', '/teacher/papers/{id}/questions/{qid}/marks', [PaperController::class, 'updateQuestionMarks']],
    ...
    ['POST', '/teacher/stamps/shortcuts', [StampController::class, 'setShortcuts']],
    ...
    ['GET', '/admin/data-protection', [AdminController::class, 'dataProtection']],
    ['GET', '/admin/data-protection/{id}/export', [AdminController::class, 'exportUserData']],
    ['POST', '/admin/data-protection/{id}/anonymize', [AdminController::class, 'anonymizeUser']],
    ['POST', '/admin/data-protection/delete-old', [AdminController::class, 'deleteOldData']],
